...
<head>
<meta charset="UTF-8">
<title>Danh tác giả</title>
</head>
<body>
	<div class="main-content">
	<form action="<c:url value='/admin-author'/>" id = "formSubmit" method="get">
...
<%--									<div class="pull-right tableTools-container">--%>
										<div class="dt-buttons btn-overlap btn-group">
											<a flag="info"
											   ...
											   href='<c:url value="/admin-author?type=edit"/>'> <span>
													<i class="fa fa-plus-circle bigger-110 purple"></i>
											</span>
											</a>
											<button id="btnDelete" type="button"
													class="dt-button buttons-html5 btn btn-white btn-primary btn-bold"
													data-toggle="tooltip" title='Xóa tác giả'>
								...
								<table class="table table-bordered">
									...
									<tbody>
										<c:forEach var="item" items="${model_song.list_item}">
											<tr>
												<th><input type="checkbox" name="" id="check_${item.id_author}" value="${item.id_author}"></th>
...
<%--													</a>--%>
														<a
																class="btn btn-sm btn-primary btn-edit"
																data-toggle="tooltip" title='Chỉnh sửa tác giả'
																href='<c:url value="/admin-author?type=edit&id_author=${item.id_author}"/>'>
															<i class="fa fa-pencil-square-o" aria-hidden="true"></i>
														</a>
												</td>
											</tr>
		...
		function deleteauthor(data){
			$.ajax({
				...
				success: function (result){
					window.location.href = "${Authorurl}?type=list&page=1&maxpage=2";
				},
